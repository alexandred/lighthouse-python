...
DEFAULT_CHROME_FLAGS = "--headless --no-sandbox"
...
class LighthouseRunner:
    ...
    def __init__(
        ...
        Args:
            ...
            config (str, optional): The Lighthouse config to use for the test.
    ...
    def _run(
        ...
        Args:
            ...
            preset (str, optional): The Lighthouse config to use for the test.
...
class LighthouseRepeatRunner:
    ...
    def __init__(
        ...
        for i in progress:
            ...
            reports.append(LighthouseRunner(
                url,
...
class BatchRunner:
    ...
    def __init__(
        ...
        for url, factor in all_combinations:
            ...
            report = LighthouseRepeatRunner(
                url,
                factor,
                quiet,
                chrome_flags,
                additional_settings,
                repeats=repeats,timings=timings
            ).report
